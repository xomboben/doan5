...
export class SidebarComponent implements OnInit, AfterViewInit {
  ...
  {name:'Hàng hóa',url:'',icon:'signal',childs:[{name:'Quản lý danh muc',url:'/product/category'},{name:'Quản lý nha xuat ban',url:'/product/nhaxuatban'},{name:'Quản lý sản phẩm',url:'/product/product'}]}];
  constructor() { } 
  ngOnInit(): void {
  }
  ngAfterViewInit() {
